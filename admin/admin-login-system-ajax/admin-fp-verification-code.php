<?php
// admin-fp-verification-code.php
session_start();
...
if(isset($_GET['admin-verify-submit'])){
	...
	$code = (is_numeric($admin_v_code) ? (int)$admin_v_code : 0);
	if(is_int($code)){
    $check_code = "SELECT * FROM admin WHERE a_vcode = $code";
    ...
    if(mysqli_num_rows($code_res) > 0){
        ...
        $error_message = "Sorry, Wrong verification code. ";
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="info d-flex align-items-center">
								<div class="content">
									<div class="logo">
										<h1> Admin Forgot Password. Verification</h1> 
									</div>
						...
						<div class="col-lg-6 bg-white">
							<div class="form d-flex align-items-center">
								<div class="content" id="admin-login-form" >
									<form method="get" action="admin-fp-verification-code.php" class="form-validate">
