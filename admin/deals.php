...
<div class="content-inner">
	                    ...
	                    <div class="col-sm-6">
	                      ...
	                      <div class="invalid-feedback">Please Enter Estimate Amount</div>
			                ...
			                <?php
				                ...
				                $tooltip_text = "If you select amount, deal need to reach till estimate amount if not reach deal will be close according to date which site fixed.
				                if you select date & time, deal will be finish according to entered date and time, in this case wheather estimate amount not reach what you enterd even though deal will be close."
			                ?>
		                <div class="form-group row">
  ...
  <footer class="main-footer">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <p>Ananas &copy; 2021-2023</p>
        </div>
        <div class="col-sm-6 text-right">
          <p>Design by <a href="#" class="external">Baazdesigner</a></p>
...
// 
	// const input = document.querySelector('#u-price');
