...
$sql ="SELECT * FROM products WHERE admin_id = {$a_id} ORDER BY ID DESC LIMIT {$offset},{$limit_per_page}";
	 ...
	 $output = '<div class="table-responsive">   
		            <table class="table table-striped table-sm">
		              ...
		              while ($row = mysqli_fetch_assoc($result)) {
		                  ...
		                  <td><img src='../All-Products-images/{$row["image_0"]}' class='rounded img-thumbnail' width='50px' height='50px' ></td>
		                  ...
		                  $view_button = "<a href='view-deals.php?pid={$row["ID"]}'>
