...
if(mysqli_num_rows($result)>0){
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        $output.="  <div class='form-group col-lg-12'>
        			  	...
        			  	<label>Name</label>
		              	<input id='user_name_edit' type='text' value='{$row["name"]}' class='mb-2 form-control w-100'>
		            </div>
		            <div class='form-group col-lg-6 '>
		            	<label>Country Code</label>
		             	<input id='user_c_code_edit' type='number' value='{$row["countrycode"]}' class='mb-2 form-control w-100'>
		            </div>
		            <div class='form-group col-lg-6 '>
		            	<label>Mobile Number</label>
		              	<input id='user_mobile_edit' type='number' value='{$row["mobile"]}' class='mb-2 form-control w-100'>
		            </div>
		            <div class='form-group col-lg-12'>
        			  	<label>Email</label>
		              	<input id='user_email_edit' type='email' value='{$row["email"]}' class='mb-2 form-control w-100'>
		            </div>
		            <div class='form-group col-lg-6'>
