...
session_start();
 ...
 if(isset($_POST['admin-signup'])){
    ...
    $email_check = "SELECT * FROM m_admin WHERE a_email = '$admin_email'";
    ...
    if(mysqli_num_rows($res_check) > 0){
        ...
        $vstatus = "notverified";
        $insert_data = "INSERT INTO m_admin (a_username,a_fullname,a_email,a_gender,a_password,a_phone,a_phonecode,a_country,a_vcode,a_vstatus,a_status,a_dateofbirth,a_createtime,a_updatetime,a_profilepic)
        ...
        if($data_check){
            ...
            // if($mail || $sms){
                ...
                $_SESSION['ma_email']    = $admin_email;
                $_SESSION['ma_password'] = $admin_password;
                $_SESSION['ma_id']       = $last_id;
