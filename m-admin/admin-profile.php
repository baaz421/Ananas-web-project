...
include 'header.php';
$a_id = $_SESSION['ma_id'];
$sql_get_admin_data = "SELECT * FROM m_admin WHERE AID = {$a_id}";
            ...
            <div class="card-body text-center">
             ...
             <hr class="rounded">
              <div class="client-title m-3">
                ...
                <a href="#" class="bg-primary">Joined Date : <?php	echo joinDate($admin_data['a_createtime']);?></a>
            ...
            <div class="card-body">
               <form method="post" id="submit-r-admin" >
                  ...
                  <div class="form-footer">
                      <button type="submit"  name="save-changes" id="save-changes" value="save-changes" class="btn btn-outline-primary w-100">
