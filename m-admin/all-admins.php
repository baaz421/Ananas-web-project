...
$(document).ready(function(){
	// load table data
		function loadTable(page){
			$.ajax({
				url : "all-country-admins/load-admins-data.php",
				type : "POST",
				data : {page_no:page},
	...
	//show modal box
		$(document).on("click", "#eid", function(){
			...
			var cat_id = $(this).data("eid");
				...
				$.ajax({
					url : "all-country-admins/load-admins-edit-options.php",
					type : "POST",
					data : {id:cat_id},
					success : function(data){
	...
	//update users 
		$(document).on("click", "#change-button", function(){
			...
			var user_edit_email = $("#user_email_edit").val();
				$.ajax({
					 url : "all-country-admins/edit-admins-data.php",
					 type : "POST",
	...
	//live search
		$("#search_val").on("keyup",function(){
			...
			//alert(search_term, "Hello, world!");
				$.ajax({
					url : "all-country-admins/admins-live-search.php",
					type : "POST",
	...
	//active deactive status 
		$(document).on("click", "#status-button", function(){
			...
			var sta_id = $(this).data("sid");
				$.ajax({
					url : "all-country-admins/admins-status-update.php",
					type : "POST",
	...
	//verified or not verified 
		...
		var verfiy_id = $(this).data("vid");
			$.ajax({
				url : "all-country-admins/admins-verify-update.php",
				type : "POST",
