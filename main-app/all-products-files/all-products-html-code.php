                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Nunc dignissim risus</a></h3><!-- End .product-title -->
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Cras ornare tristique</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $32.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Aliquam tincidunt mauris</a></h3><!-- End .product-title -->
                                <div class="product-price">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Brown paperbag waist pencil skirt</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $60.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Dark yellow lace cut out swing dress</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $84.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Khaki utility boiler jumpsuit</a></h3><!-- End .product-title -->
                                <div class="product-price">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Blue utility pinafore denim dress</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $76.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Beige knitted elastic runner shoes</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $84.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Orange saddle lock front  chain cross body bag</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $52.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Yellow button front tea top</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $56.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Light brown studded Wide fit wedges</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $110.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-view.php">Black soft RI weekend travel bag</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $68.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
