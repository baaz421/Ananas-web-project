...
<input type="text" id="cat-id" value="<?php echo $category; ?>" hidden>
			...
			<div class="toolbox">
                ...
                <div class="toolbox-center">
                    <div class="toolbox-info">
                        Showing <span class="text-uppercase"><?php echo GetCatName($category,$conn); ?></span> Products
...
// load all product by ajax call
 ...
 function load_products_data(limit, start, cat_id){
  $.ajax({
   url:"all-products-files/load-categories-product.php",
   method:"POST",
 ...
 {
  action = 'active';
  load_products_data(limit, start, cat_id);
 }
