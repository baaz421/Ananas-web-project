...
<main class="main">
    ...
    <div class="container-fluid">
        ...
        <!-- ===================================== how its work is close here============================== --> 

                <div class="mb-3"></div><!-- End .mb-3 -->

            <!-- ===================================== zone 1 products and banner start here============================== -->
                <div class="row cat-banner-row electronics">
                <!-- ===================================== zone 1 products start here============================== -->
                    ...
                    <div class="col-xl-12 col-xxl-12">
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    ...
                                    <div class="product-action-vertical">
                                        ...
                                        <a href="quickview.php" class="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">MacBook Pro 13" Display, i5</a></h3><!-- End .product-title -->
                        ...
                        <!-- ===================================== zone 1 products 1 close here============================== -->
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Bose - SoundLink Bluetooth Speaker</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $79.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <!-- ===================================== zone 1 products 2 close here============================== -->
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Apple - 11 Inch iPad Pro <br>with Wi-Fi 256GB </a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $899.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <!-- ===================================== zone 1 products 3 close here============================== -->
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Google - Pixel 3 XL 128GB</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                        ...
                        <!-- ===================================== zone 1 products 5 close here============================== -->
                        </div><!-- End .owl-carousel -->
                    </div><!-- End .col-xl-10 -->
                <!-- ===================================== zone 1 products close here============================== -->
                </div><!-- End .row cat-banner-row -->
            <!-- ===================================== zone 1 products and banner close here============================== -->

                <div class="mb-3"></div><!-- End .mb-3 -->

            <!-- ===================================== zone 2 products and banner start here============================== -->
                <div class="row cat-banner-row furniture"> 
                <!-- ===================================== zone 2 products start here============================== -->
                    <div class="col-xl-12 col-xxl-12"> 
                    <h2 class="title rounded-pill text-center bg-primary p-2 ml-auto mr-auto ">ORANGE ZONE PRODUCTS</h2>           
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            data-owl-options='{
                                "nav": true, 
                                "dots": false,
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Block Side Table/Trolley</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $299.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Roots Sofa Bed</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $1,199.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Carronade Large <br>Suspension Lamp</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Wingback Chair</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $210.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                ...
                <!-- ===================================== zone 2 products close here============================== -->
                </div><!-- End .row cat-banner-row -->
            <!-- ===================================== zone 2 products and banner close here============================== -->

                <div class="mb-3"></div><!-- End .mb-3 -->

            <!-- ===================================== zone 3 products and banner start here============================== -->
                <div class="row cat-banner-row clothing">
                <!-- ===================================== zone 3 products start here============================== -->
                    <div class="col-xl-12 col-xxl-12">
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Beige faux suede runner  trainers</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $64.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Black boucle check scarf</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $36.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product text-center">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-view.php">Triple compartment cross body bag</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $64.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                ...
                <!-- ===================================== zone 3 products close here============================== -->
                </div><!-- End .row cat-banner-row -->
            <!-- ===================================== zone 3 products and banner close here============================== -->
                            ...
                            <div class="widget widget-products">
                                ...
                                <div class="products">
                                    <div class="product product-sm">
                                        ...
                                        <div class="product-body">
                                            <h5 class="product-title"><a href="product-view.php">User - 12345</a></h5><!-- End .product-title -->
                                            <div class="product-price">
                                                100 - QR
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                    ...
                                    <div class="product product-sm">
                                        ...
                                        <div class="product-body">
                                            <h5 class="product-title"><a href="product-view.php">User - 32423</a></h5><!-- End .product-title -->
                                            <div class="product-price">
                                                10 - QR
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                    ...
                                    <div class="product product-sm">
                                        ...
                                        <div class="product-body">
                                            <h5 class="product-title"><a href="product-view.php">User  - 65657</a></h5><!-- End .product-title -->
                                            <div class="product-price">
                                                5 - QR
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                    ...
                                    <div class="product product-sm">
                                        ...
                                        <div class="product-body">
                                            <h5 class="product-title"><a href="product-view.php">User - 98767</a></h5><!-- End .product-title -->
                                            <div class="product-price">
                                                50 - QR
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                    ...
                                    <div class="product product-sm">
                                        ...
                                        <div class="product-body">
                                            <h5 class="product-title"><a href="product-view.php">User - 56556</a></h5><!-- End .product-title -->
                                            <div class="product-price">
                                                20 - QR
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                    ...
                                    <div class="col-sm-6 col-xl-12">
                                        <div class="product text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product-view.php">Bose SoundLink Micro speaker</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                    ...
                                    <div class="col-sm-6 col-xl-12">
                                        <div class="product text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product-view.php">GoPro HERO Session Waterproof HD Action Camera</a></h3><!-- End .product-title -->
                                                <div class="product-price">
