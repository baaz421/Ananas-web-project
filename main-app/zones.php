...
<input type="text" id="z-name" value="<?php echo $zone; ?>" hidden>
			...
			<div class="toolbox">
                ...
                <div class="toolbox-center">
                    <div class="toolbox-info">
                        Showing <span><?php echo $zone ?> zone</span> Products
...
// load all product by ajax call
 ...
 var start = 0;
 var action = 'inactive';
 var z_name = $("#z-name").val();
 function load_products_data(limit, start, z_name){
  $.ajax({
   url:"all-products-files/load-zone-products.php",
   method:"POST",
   data:{limit:limit, start:start, z_name:z_name},
   cache:false,
 ...
 {
  action = 'active';
  load_products_data(limit, start, z_name);
 }
